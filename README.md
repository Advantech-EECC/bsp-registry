...
| `bsp-registry.advantech-aim-linux.yaml` | `advantech-aim-linux` vendor, the Advantech AIM Linux boards and their presets |
| `bsp-registry.advantech-europe.yaml` | `advantech-europe` vendor, the Advantech Europe (modular BSP) boards and their presets |
| `bsp-registry.nvidia.yaml` | `nvidia` vendor, the NVIDIA Jetson devkits and their presets |
...
shadowing the shared entry. See [Registry Model](docs/registry-model.md) for the full merge
semantics.
...
| -------------- | :-------: | ------------- |
| **Genio 350 EVK** | 🅿️    | 🟡 Development |
| **Genio 510 EVK** | 🅿️    | 🟡 Development |
| **Genio 700 EVK** | 🅿️    | 🟡 Development |
...
| **Hardware**         | **Preset** | **Supported Releases** | **Status**       | **Documentation** |
|----------------------|------------|------------------------|------------------|-------------------|
| **Genio 350 EVK**    | `mediatek-genio-350-evk` | scarthgap | 🟡 Development   | [MediaTek Genio 350 EVK](https://mediatek.gitlab.io/aiot/doc/aiot-dev-guide/master/hw/g350-evk.html) |
| **Genio 510 EVK**    | `mediatek-genio-510-evk` | scarthgap | 🟡 Development   | [MediaTek Genio 510 EVK](https://mediatek.gitlab.io/aiot/doc/aiot-dev-guide/master/hw/g510-evk.html) |
| **Genio 700 EVK**    | `mediatek-genio-700-evk` | scarthgap | 🟡 Development   | [MediaTek Genio 700 EVK](https://mediatek.gitlab.io/aiot/doc/aiot-dev-guide/master/hw/g700-evk.html) |
...
# Build MediaTek Genio 350 EVK (scarthgap)
bsp build mediatek-genio-350-evk-scarthgap
...
| Board \ Yocto         | scarthgap | Status        |
| --------------------- | :-------: | ------------- |
| **QCM6490 IDP**       |     🅿️     | 🟡 Development |
| **QCS615 ADP Air**    |     🅿️     | 🟡 Development |
| **IQ-615 EVK**        |     🅿️     | 🟡 Development |
| **QCS6490 RB3gen2**   |     🅿️     | 🟡 Development |
| **IQ-8275 EVK**       |     🅿️     | 🟡 Development |
| **IQ-8300 EVK (Monza)** |   🅿️     | 🟡 Development |
| **QCS8300 Ride SX**   |     🅿️     | 🟡 Development |
| **IQ-9075 EVK**       |     🅿️     | 🟡 Development |
| **QCS9075 Ride SX**   |     🅿️     | 🟡 Development |
| **QCS9100 Ride SX**   |     🅿️     | 🟡 Development |
| **AOM-2721**          |     🔍     | 🔍 Preview     |
...
| **Hardware**          | **Preset** | **Supported Releases** | **Status**     | **Documentation** |
|-----------------------|------------|------------------------|----------------|-------------------|
| **QCM6490 IDP**       | `qcm6490-idp` | scarthgap | 🟡 Development | [Qualcomm QCM6490](https://www.qualcomm.com/products/internet-of-things/industrial/industrial-automation/qcm6490) |
| **QCS615 ADP Air**    | `qcs615-adp-air` | scarthgap | 🟡 Development | [Qualcomm QCS615](https://www.qualcomm.com/products/automotive/qcs615) |
| **IQ-615 EVK**        | `qcs615-iq-615-evk` | scarthgap | 🟡 Development | [Qualcomm IQ-615](https://www.qualcomm.com/developer/hardware/iq-615-development-kit) |
| **QCS6490 RB3gen2**   | `qcs6490-rb3gen2-core-kit`, `qcs6490-rb3gen2-industrial-kit`, `qcs6490-rb3gen2-vision-kit` | scarthgap | 🟡 Development | [Qualcomm RB3gen2 Vision Kit](https://www.qualcomm.com/developer/hardware/rb3-gen-2-development-kit) |
| **IQ-8275 EVK**       | `qcs8275-iq-8275-evk`, `qcs8275-iq-8275-evk-ifp`, `qcs8275-iq-8275-evk-pro-sku`, `qcs8275-iq-8275-evk-pro-sku-ifp` | scarthgap | 🟡 Development | [Qualcomm IQ-8275](https://www.qualcomm.com/developer/hardware/iq-8275-evk) |
| **IQ-8300 EVK (Monza)** | `monaco-monza` | scarthgap | 🟡 Development | [Qualcomm QCS8300](https://www.qualcomm.com/products/automotive/qcs8300) |
| **QCS8300 Ride SX**   | `qcs8300-ride-sx` | scarthgap | 🟡 Development | [Qualcomm Ride SX](https://www.qualcomm.com/developer/hardware/ride-sx-development-kit) |
| **IQ-9075 EVK**       | `qcs9075-iq-9075-evk`, `qcs9075-iq-9075-evk-ifp` | scarthgap | 🟡 Development | [Qualcomm IQ-9075](https://www.qualcomm.com/developer/hardware/iq-9075-evk) |
| **QCS9075 Ride SX**   | `qcs9075-ride-sx` | scarthgap | 🟡 Development | [Qualcomm Ride SX](https://www.qualcomm.com/developer/hardware/ride-sx-development-kit) |
| **QCS9100 Ride SX**   | `qcs9100-ride-sx` | scarthgap | 🟡 Development | [Qualcomm Ride SX](https://www.qualcomm.com/developer/hardware/ride-sx-development-kit) |
