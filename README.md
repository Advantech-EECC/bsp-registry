...
| **i.MX8MQ EVK** | whinlatter, walnascar, styhead, scarthgap | 🟡 Development | *Upstream meta-imx machine config:* `imx8mqevk` |
| **i.MX8ULP 9x9 LPDDR4X EVK** | whinlatter, walnascar, styhead, scarthgap | 🟡 Development | *Upstream meta-imx machine config:* `imx8ulp-9x9-lpddr4x-evk` |
| **i.MX8ULP EVK** | whinlatter, walnascar, styhead, scarthgap | 🟢 Stable | *Upstream meta-imx machine config:* `imx8ulpevk` |
| **i.MX91 11x11 LPDDR4 EVK** | whinlatter, walnascar, styhead, scarthgap | 🟡 Development | *Upstream meta-imx machine config:* `imx91-11x11-lpddr4-evk` |
| **i.MX91 EVK** | whinlatter, walnascar, styhead, scarthgap | 🟡 Development | *Upstream meta-imx machine config:* `imx91evk` |
| **i.MX93 11x11 LPDDR4X PF0900 EVK** | whinlatter, walnascar, styhead, scarthgap | 🟡 Development | *Upstream meta-imx machine config:* `imx93-11x11-lpddr4x-pf0900-evk` |
| **i.MX93 EVK** | whinlatter, walnascar, styhead, scarthgap | 🟡 Development | *Upstream meta-imx machine config:* `imx93evk` |
| **i.MX93W 14x12 LPDDR4X EVK** | whinlatter, walnascar, styhead, scarthgap | 🟡 Development | *Upstream meta-imx machine config:* `imx93w-14x12-lpddr4x-evk` |
| **i.MX941 19x19 LPDDR4 EVK** | whinlatter, walnascar, styhead, scarthgap | 🟡 Development | *Upstream meta-imx machine config:* `imx941-19x19-lpddr4-evk` |
| **i.MX942 19x19 LPDDR4 EVK** | whinlatter, walnascar, styhead, scarthgap | 🟡 Development | *Upstream meta-imx machine config:* `imx942-19x19-lpddr4-evk` |
| **i.MX943 15x15 LPDDR4 EVK** | whinlatter, walnascar, styhead, scarthgap | 🟡 Development | *Upstream meta-imx machine config:* `imx943-15x15-lpddr4-evk` |
| **i.MX943 19x19 LPDDR4 EVK** | whinlatter, walnascar, styhead, scarthgap | 🟡 Development | *Upstream meta-imx machine config:* `imx943-19x19-lpddr4-evk` |
| **i.MX943 19x19 LPDDR5 EVK** | whinlatter, walnascar, styhead, scarthgap | 🟡 Development | *Upstream meta-imx machine config:* `imx943-19x19-lpddr5-evk` |
| **i.MX943 EVK** | whinlatter, walnascar, styhead, scarthgap | 🟡 Development | *Upstream meta-imx machine config:* `imx943evk` |
| **i.MX95 15x15 LPDDR4X EVK** | whinlatter, walnascar, styhead, scarthgap | 🟡 Development | *Upstream meta-imx machine config:* `imx95-15x15-lpddr4x-evk` |
